...
-- 3. Tabel Ownership (relasi many-to-many)
CREATE TABLE Ownership (
    ParcelID VARCHAR(50),
    OwnerID INT,
    PRIMARY KEY (ParcelID, OwnerID),
    FOREIGN KEY (ParcelID) REFERENCES Property(ParcelID),
    FOREIGN KEY (OwnerID) REFERENCES Owner(OwnerID)
);

-- 4. Tabel Sale (transaksi jual beli)
CREATE TABLE Sale (
    UniqueID INT PRIMARY KEY AUTO_INCREMENT,  -- Auto increment juga buat UniqueID (MySQL)
    ParcelID VARCHAR(50),
    SaleDate DATE,
...
-- 5. Tabel Valuation (nilai properti)
...
#TABLE PROPERTY
LOAD DATA LOCAL INFILE 'C:/Data housing/Property.csv'
INTO TABLE Property
...
IGNORE 1 LINES;
#TABLE OWNER
LOAD DATA LOCAL INFILE 'C:/Data housing/Owner.csv'
INTO TABLE Owner
FIELDS TERMINATED BY ','
ENCLOSED BY '"'
LINES TERMINATED BY '\r\n'
IGNORE 1 LINES;
#TABLE OWNERSHIP
LOAD DATA LOCAL INFILE 'C:/Data housing/Ownership.csv'
INTO TABLE Ownership
FIELDS TERMINATED BY ','
ENCLOSED BY '"'
LINES TERMINATED BY '\r\n'
IGNORE 1 LINES;
#TABLE SALE
LOAD DATA LOCAL INFILE 'C:/Data housing/Sale.csv'
INTO TABLE PropertySales
FIELDS TERMINATED BY ';'
LINES TERMINATED BY '\r\n'
IGNORE 1 LINES;
#TABLE VALUATION
LOAD DATA LOCAL INFILE 'C:/Data housing/Valuation.csv'
